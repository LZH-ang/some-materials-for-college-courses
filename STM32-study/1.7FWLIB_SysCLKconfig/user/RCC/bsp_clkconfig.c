...
void MCO_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA, ENABLE);//开启多个时钟用"|"	
	
	GPIO_MCO.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_MCO.GPIO_Mode = GPIO_Mode_AF_PP;
	GPIO_MCO.GPIO_Pin = GPIO_Pin_8;
	GPIO_Init(GPIOA, &GPIO_MCO);
